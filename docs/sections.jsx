...
const PILLARS = [
  { n: "01", q: "Who",
    d: "Every active subscriber is scored. The ones most likely to leave in the next 30 days surface at the top — ranked, explained, and ready for a decision." },
  { n: "02", q: "Why",
    d: "Each subscriber comes with a reason: the behavioral signals driving their risk, weighted and readable. Not a score with nothing behind it — a case you can assess and act on." },
  { n: "03", q: "What",
    d: "The reason determines the response. A lapsed card gets a one-tap update link. A two-year subscriber going quiet gets a pause offer. Price anxiety gets a value reframe. The right action for the actual problem." },
  { n: "04", q: "Learn",
    d: "Every intervention you approve gets tracked against an outcome. You see what worked, what didn't, and where the highest returns are. The record builds with every cycle." }];
        ...
        <div className="method-intro">
          <Reveal>
            <img src="bellwether_bottle_and_vial.png" alt=""
              ...
              style={{width:"100%",height:"308px",objectFit:"cover",objectPosition:"42% center",
              ...
              <div className="dos-id">
                <div className="dos-arch">
                  ...
                  {(() => {
                    ...
                    return more > 0 ? (
                      <button onClick={() => setSortMode("reason")} style={{
                        appearance:"none",border:"none",background:"none",cursor:"pointer",
                        fontFamily:"var(--font-mono)",fontSize:"11px",color:"var(--ink-3)",
                        letterSpacing:"0.06em",padding:"0 0 0 12px",
                ...
                {!st ?
                  <div className="action-cta">
                    ...
                    <div className="alts">
                      ...
                      {sub.alternatives.map((a, i) => (
                        <button key={i} className="alt" style={{
                          appearance:"none",border:"none",background:"transparent",
                          cursor:"pointer",padding:0,font:"inherit",textAlign:"left"
                        }} onClick={() => decide("approved")}>{a}</button>
                      ))}
                    </div>
                  </div> :
                  <div className="action-cta">
